...
// For Render deployment, use RENDER_USER_DB_PATH if available, otherwise use USER_DB_PATH
// Fallback to local file if neither is set
const dbPath = 
  process.env.RENDER_USER_DB_PATH ||
  process.env.USER_DB_PATH ||
  path.join(__dirname, '..', 'user_cargo_management.db');

console.log('Using user database path:', dbPath);
